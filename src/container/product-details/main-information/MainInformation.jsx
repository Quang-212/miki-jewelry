...
import Animation, { RIGHT_LEFT } from 'src/components/Animation';
...
export default function MainInformation({ product, averageRating }) {
  ...
  return (
    ...
    >
      <Animation variant={RIGHT_LEFT} className="flex flex-col gap-4 w-[450px]">
        ...
        {discount ? (
          <>
            <div className="flex items-center gap-4 mt-5">
              ...
              <span className="py-1 px-2 rounded-tag bg-discount text-neutral-5">
                - {discount}%
              </span>
              <Button
                leftIcon={
