...
export function ProductsListSection({ initProducts }) {
  ...
  if (isSwr && isLoading)
    return <LoadingRotatingLines className="absolute z-10 left-2/4 top-3/4" />;
  ...
  return (
    <section className="container mt-10 flex flex-col gap-8">
      ...
      <ProductsPagination page={page} setPage={setPage} limit={limit} setLimit={setLimit} />
    </section>
  );
}
