...
export default function OrderItem({ data }) {
  ...
  return (
    <>
      {orders.map((order) => (
        <li>
          <h5 className="heading-5 text-neutral-2">Mã đơn hàng: {order._id}</h5>
        ...
        /> */}
            ...
            <h5 className="col-span-8 heading-5">{}</h5>
            <span className="col-span-2 justify-self-end heading-5 text-primary-2">{}</span>
